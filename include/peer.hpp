...
class PeerClient {
    public:
        ...
        void request_block(uint32_t piece_index, uint32_t block_offset, uint32_t block_length);
        std::vector<uint8_t> download_piece(uint32_t piece_index, uint32_t piece_length);
